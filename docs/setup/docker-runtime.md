...
restart, but does not delete old data. Configurable retention cleanup is stored
in database settings, runs after unlock, and can also be triggered manually from
Settings.
